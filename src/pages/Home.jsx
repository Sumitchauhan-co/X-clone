...
const Home = () => {
  ...
  const { inHomeIsactive, setInHomeIsactive } = useContext(FetchContext);
  ...
  return (
    <div ref={scrollRef} className="h-full border-[0_1px_0_1px] border-(--border-color) flex flex-col pb-50 relative overflow-y-scroll [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
