  ...
  return (
    <div className="h-full sm:flex justify-end hidden">
      <div className="w-[70%] h-full flex justify-start flex-col relative">
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <span className={`h-fit w-fit text-(--current-color) ${isActive ? "font-bold" : ""} text-xl p-[0_20px_0_17px] hidden xl:block`}>
                    Home
                  </span>
                </>
              )}
        ...
        <div className="h-[9vh] w-[95%] hover:bg-(--hover-color) flex items-center absolute bottom-0 border rounded-4xl lg:p-3 p-0 lg:ml-0 m-3 cursor-pointer">
